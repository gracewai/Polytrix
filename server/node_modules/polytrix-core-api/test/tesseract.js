...
describe('Stream', function() {
    ...
    describe.skip('create and upload file',function(){
        it('should upload a file and return success', function(done){
            var stats = fs.statSync(__dirname+'/todo.txt');
            tesseract.stream.createAndUploadStream('0e2fa86dce6dd8ee66a25e6c7caf0eeeb6779b3d',fs.createReadStream(__dirname+'/todo.txt'),stats.size,'test.html')
                .then(function(response){
                    console.log(response);
                    response.success.should.equal(true);
                    response.identifier.should.be.ok;
    ...
    describe.skip('update file',function(){
        it('should upload a file and return success', function(done){
            var stats = fs.statSync(__dirname+'/test.html');
            tesseract.stream.uploadStream('b29a98fd160b3b741fe8d767860cb51ecd983392',fs.createReadStream(__dirname+'/test.html'),stats.size,true)
                .then(function(response){
                    console.log(response);
                    response.success.should.equal(true);
                    response.identifier.should.be.ok;
    ...
    describe('download and upload file',function(){
        it('should retreive a stream and upload it', function(done){
            tesseract.stream.downloadStream('b29a98fd160b3b741fe8d767860cb51ecd983392')
                .then(function(response){
                    response.mimeType.should.be.ok;
                    return tesseract.stream.createAndUploadStream('0e2fa86dce6dd8ee66a25e6c7caf0eeeb6779b3d',response,response.mimetype,'testing__222.txt');
                })
                .then(function(response){
                    console.log(response);
                    response.success.should.equal(true);
