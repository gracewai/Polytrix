...
var authenticator = function(access_token,refresh_token,api_url,json){
...
var downloadFilePipe = function(location,access_token,refresh_token,res){
	console.log('function not implemented, use downloadFileInstead');

	return downloadFileLink(location,access_token,refresh_token)
	.then(function(url){
		res.redirect(url);
	});
};
...
var getQouta = function(access_token,refresh_token){
