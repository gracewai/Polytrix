...
var setToken = function(req){
	...
	return onedriveProvider.oAuthGetAccessToken(req.query.code)
	.then(function(results)
	{
		var sess = req.session;
		sess.onedrive = sess.onedrive || new Object(); //initialize onedrive object if not created.
		sess.onedrive.access_token = results.access_token;
		sess.onedrive.refresh_token = results.refresh_token;
		console.log(results);
		return sess.onedrive;
	})
	.catch(function(err){
		console.log(err);
	});	
