...
Operation.prototype = {
	create: function(destinationFileId,    others){
		return this.provider.operation.create(this.tokens.access_token,this.tokens.refresh_token,destinationFileId,    others);
	},

	rename: function(fileId,    others){
		return this.provider.operation.rename(this.tokens.access_token,this.tokens.refresh_token,fileId,    others);
	},
